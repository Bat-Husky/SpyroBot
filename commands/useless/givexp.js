...
const fs = require('fs');
const xpImg = new Discord.AttachmentBuilder('./Img/XP.png', { name: 'XP.png'})
const stoImg = new Discord.AttachmentBuilder('./Img/STONKS.jpg', { name: 'STONKS.jpg'})
...
module.exports = class GiveXP extends commands {
    ...
    static action (message) {
        ...
        const embed = new EmbedBuilder()
              ...
              .setFooter({ text: "Sponsorisé par STONKS !", iconURL: "attachment://STONKS.jpg"})
